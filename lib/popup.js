...
function init() {
	...
	chrome.runtime.sendMessage(chrome.runtime.id, {'action': 'get-initial'});

	$('#ignore').click(function() {
		chrome.runtime.sendMessage(chrome.runtime.id, {'action': 'ignore'});
	...
	$('#clear').click(function() {
		chrome.runtime.sendMessage(chrome.runtime.id, {'action': 'reset-savings'});
