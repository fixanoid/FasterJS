...
// TODO: Broken, investigate further
//			1. When a font is encountered, webRequest is executed multiple times
//			2. Replacing fonts with data url for some reason gives an error
// browser.webRequest(findFonts, { urls: [ '*://*/*.woff*', '*://*/*.woff2*' ] });
