...
chrome.webRequest.onBeforeRequest.addListener(findCDNs, { urls: ['*://code.jquery.com/*', '*://cdnjs.cloudflare.com/*', '*://ajax.googleapis.com/*'] }, ['blocking']);
...
function fromCache(key) {
	if (!cache[key]) {
		var local = chrome.extension.getURL('db/' + lookup[key].file);
