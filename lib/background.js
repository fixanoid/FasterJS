...
var db = [{
	...
	{
		matchType: 'end-match',
		matches: [ 'underscore.js', 'underscore-1.8.2.min.js' ],
		...
		matchType: 'end-match',
		matches: [ 'jquery-1.6.1.min.js', 'jquery.js?ver=1.6.1', 'jquery.min.js?ver=1.6.1' ],
		file: 'jquery-1.6.1.min.js'
	}, {
		matchType: 'end-match',
		matches: [ 'jquery-1.7.1.min.js', 'jquery.js?ver=1.7.1', 'jquery.min.js?ver=1.7.1' ],
		...
		matchType: 'end-match',
		matches: [ 'jquery-1.10.2.min.js', 'jquery.js?ver=1.10.2', 'jquery.min.js?ver=1.10.2' ],
	...
	{
		matchType: 'exact',
		matches: [ 'http://cdnjs.cloudflare.com/ajax/libs/jquery/1.8.3/jquery.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/1.8.3/jquery.min.js' ],
		file: 'jquery-1.8.3.min.js'
	}, {
		matchType: 'exact',
		matches: [ 'http://cdnjs.cloudflare.com/ajax/libs/jquery/2.0.3/jquery.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/2.0.3/jquery.min.js' ],
		file: 'jquery-2.0.3.min.js'
	}, {
		matchType: 'exact',
		matches: [ 'http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.1/jquery.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.1/jquery.min.js' ],
		file: 'jquery-2.1.1.min.js'
	}, {
		matchType: 'exact',
		matches: [ 'http://cdnjs.cloudflare.com/ajax/libs/zeroclipboard/1.3.2/ZeroClipboard.min.js' ],
		...
		matchType: 'exact',
		matches: [ 'http://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.6.0/underscore-min.js', 'https://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.6.0/underscore-min.js' ],
		...
		matchType: 'exact',
		matches: [ 'http://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.1.2/backbone-min.js', 'https://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.1.2/backbone-min.js' ],
		file: 'backbone-1.1.2.min.js'
	}, {
		matchType: 'exact',
		matches: [ 'http://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.11/require.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.11/require.min.js' ],
		file: 'require-2.1.11.min.js'
	}, {
		matchType: 'exact',
		matches: [ 'http://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/highlight.min.js', 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.4/highlight.min.js' ],
